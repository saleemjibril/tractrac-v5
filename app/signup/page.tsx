...
export default function Home() {
  ...
  return (
                ...
                Your Chakra experience may be degraded.
                  ...
                  <Checkbox defaultChecked colorScheme="orange">
                    <Box as="span" fontSize="12px" lineHeight="5px">
                      ...
                      accepted the <Link color="#1373E6">Terms of Use</Link> and{" "}
    ...
    // <>
    //   <TracTracPageModal title="Create an account" modalType={SignupModal}>
    //     <SignupModalComponent />
    //   </TracTracPageModal>

    //   <Box textAlign="center" p={0} m={0} mt="40vh">
    //     <Center>
    //       <CircularProgress size="60px" display="block" isIndeterminate color="#F8A730" />
    //     </Center>
    //   </Box>
    // </>
  );
